...
class PoseEstimator():
    ...
    def _get_full_model_points(self, filename='./data/pose_estimator/model.txt'):
    ...
    def solve_pose_by_68_points(self, image_points):
        ...
        return np.asarray(rotation_vector.tolist() + translation_vector.tolist()).flatten().tolist()
